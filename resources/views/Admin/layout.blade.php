...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ admin_templatedist/css/adminlte.min.css }}">
</head>
...
{{-- <!-- PAGE {{ admin_template/PLUGINS --> --}}
// <!-- jQuery Mapael -->
<script src="{{ admin_template/plugins/jquery-mousewheel/jquery.mousewheel.js }}"></script>
<script src="{{ admin_template/plugins/raphael/raphael.min.js }}"></script>
<script src="{{ admin_template/plugins/jquery-mapael/jquery.mapael.min.js }}"></script>
<script src="{{ admin_template/plugins/jquery-mapael/maps/usa_states.min.js }}"></script>
<!-- ChartJS -->
...
<script src="{{ admin_template/dist/js/pages/dashboard2.js }}"></script>
</body>
</html>
