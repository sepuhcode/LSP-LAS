...
<div class="row px-0 py-5 m-0 justify-content-center footer">
    <div class="row p-0" style="width: 80%">
        <div class="col-4">
            <img src="{{ asset('images/LogoLAS.png') }}" width="120px" />
            <ul>
                <li><a href="#">Home </a></li>
        ...
        <div class="col-4 text-white">
            <h4>Tentang Kami</h4>
            <p>LSP LAS lembaga sertifikasi untuk</p>
            <p>profesi pengelasan yang didirikan</p>
            <p>oleh Asosiasi Pengelasan Indonesia</p>
            <p>dan Terlisensi oleh Badan Nasional</p>
            <p>Sertifikasi Profesi.</p>
...
{{-- <div class="footer">
    <div class="container-footer">
        <div class="row-footer" >
            ...
            <div class="footer-col col-5" style="">
                <h4 >Tentang Kami</h4>
                <p class="col-10" style="text-align=justify">LSP LAS lembaga sertifikasi untuk
            ...
            <div class="footer-col col-4" style="">
                <h4 >Alamat</h4>
                <p style="">
                    Graha Surveyor Indonesia Lt. 14
                    Jl. Gatot Subroto Kav. 56 Jakarta Selatan<br>
                    Tlp : 0819 17100200
                    Post code : 12950
                </p>
