...
<body>
    ...
    <div class="carousel-inner-content2">
        <img src="{{ asset('Images/Content-Dashboard.png') }}"/>
    </div>
    <div class="row mx-2 mt-2" style="background-color: #EFEFEF">
        {{-- style="border-left: 3px solid red; border-top: 3px solid red; border-top-left-radius: 300px;"> --}}
        <div> 
            <div class="col-12 text-center">
                <h1 class="fw-semibold fs-4" style="color: red; position:relative; top: 5px;"><span style= position: relative; padding: 0 30px;>Visi Misi LSP LAS</span></h1>
                <h2 class="fw-semibold mx-auto mt-5 mb-5 fs-5" style="color: #959595; width: 760px;">
    ...
    <div class="container-footer">
        <div class="row-footer" >
            <div class="footer-col" style="margin-right: 20px">
                <img src="{{ 'images/LogoLAS.png' }}" class="logo-footer"/>
                <ul>
                    <li><a href="#">Home </a></li>
            ...
            <div class="footer-col" style="margin-right: 20px">
                ...
                <p style="text-align: justify">
                    Graha Surveyor Indonesia Lt. 14
                    Jl. Gatot Subroto Kav. 56 Jakarta Selatan
                    Tlp : 0819 17100200
                    Post code : 12950
                </p>
                
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.1850074093113!2d106.82989237581323!3d-6.2393303610991895!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3c2f78e1417%3A0x6e69dc9146860164!2sPT%20Surveyor%20Indonesia%20(Persero)%20Tbk!5e0!3m2!1sid!2sid!4v1697885207960!5m2!1sid!2sid" 
